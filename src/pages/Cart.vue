<template>
  <div class="grid container mx-auto max-w-277 px-4 gap-4">
    <div
    ...
    <div
      class="grid py-4 px-4 pb-3 max-h-content bg-white rounded-3xl shadow gap-4">
      <div class="flex justify-between gap-2">
        <p class="font-semibold">Доставка</p>
        <p class="font-semibold">499 ₽</p>
      </div>
